...
@PulseAutoRegister
public class DreamfireDiscordMessageVariableTest implements DreamfireVariableTest {
    @Override
    ...
    @Override
    public Object ReturnDefaultValue() { return Messages.ConsoleEnabledSystem; }
